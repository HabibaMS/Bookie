  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        padding: const EdgeInsets.all(10.0),
          ...
          children: [
          Image(
            image: AssetImage('assets/empty_cart.jpg'),
            ),
            SizedBox(height: 20,),
            Text('Your cart is empty 😌' ,style: Theme.of(context).textTheme.headlineSmall),
            SizedBox(height: 20,),
            Text('Explore more and shop your\nfavourite books' , textAlign: TextAlign.center ,style: Theme.of(context).textTheme.titleSmall)
            ...
            children: [
            Text(snapshot.data![index].bookName.toString() ,
            ...
            cart.removerCounter();
            cart.removeTotalPrice(double.parse(snapshot.data![index].bookPrice.toString()));
            },
            ...
            SizedBox(height: 5,),
            Text(snapshot.data![index].unitTag.toString() +" "+r"$"+ snapshot.data![index].bookPrice.toString() ,
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
            ),
            SizedBox(height: 5,),
              Align(
